    ...
    const fetchFreeWorkshops = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const free = data.data?.filter((workshop) => workshop.fee === 0) || []
        ...
        setFreeWorkshops([
          {
            ...
            description:
              "We are delighted to invite you to our free webinar, Speak to Impress: Master the Art of Presenting & Communicating with Impact. In just 60 minutes, you'll gain practical strategies to elevate your presentation and communication skills.",
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Heading Section */}
        <motion.div
          className="text-center mb-6"  // reduced from mb-12
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Join our free webinar and gain practical strategies to elevate your presentation
            and communication skills in just 60 minutes.
          </motion.p>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <motion.div
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-6"  // reduced mb
            variants={containerVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
                ...
                <div className="p-4 md:p-6">
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        {workshop.duration_v} {workshop.duration_u}
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
                      <Users className="w-4 h-4" />
                      <span>
                        {workshop.sessions_r} session
                        {workshop.sessions_r > 1 ? "s" : ""}
                      </span>
                    </div>
                  </div>
        ...
        >
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 max-w-2xl mx-auto border -mt-120 border-gray-100">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
              Ready to Master Your Communication Skills?
            </h3>
            <p className="text-gray-600 mb-6 text-sm md:text-base">
              Join our free "Speak to Impress" webinar and discover practical strategies
              to elevate your presentation and communication skills.
            </p>
