...
export default function FounderPage() {
  ...
  // Navigation function for back button (you'll need to implement based on your routing)
  const handleBackToAbout = () => {
    // Replace with your routing logic
    // For example, if using React Router: navigate('/about')
    console.log('Navigate back to about page')
  }
